    ...
    public partial class F_GestaoProfessores : Form
    {
        ...
        private void dgv_professores_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (contLinhas > 0)
            {
                ...
                tb_nomeprof.Text = dt.Rows[0].Field<string>("T_NOMEPROFESSOR");
            }
        }
        ...
        private void btn_salvar_Click(object sender, EventArgs e)
        {
            ...
            {
                vquery = "INSERT INTO tb_professores (T_NOMEPROFESSOR,T_TELEFONE) VALUES ('" +tb_nomeprof.Text+ "', '"+mtb_telefone.Text+"')";
            }
            else
            {
                vquery = "UPDATE tb_professores SET T_NOMEPROFESSOR='" + tb_nomeprof.Text + "',T_TELEFONE='"+ mtb_telefone.Text+ "' WHERE N_IDPROFESSOR=" + tb_idProfessor.Text;
            }
